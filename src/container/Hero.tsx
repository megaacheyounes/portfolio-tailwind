...
export default function Hero(props: Props) {
  return (
    <section className='min-h-500 text-white bg-b-light  relative pt-5'>
      <div className='grid grid-cols-1 justify-items-center  mt-5  '>
        ...
        <div className='  max-w-lg '>
          ...
          <div className=" absolute -translate-y-96 translate-x-96 rounded-full bg-b-dark shadow-2xl inline-flex  p-8  text-purple-600" >
            <SiKotlin size={30} />
          </div>


          <div className=" absolute -translate-y-80 translate-x-16 rounded-full bg-b-dark shadow-xl inline-flex  p-8  text-green-600" >
            <SiAndroid size={50} />
          </div>
