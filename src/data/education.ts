export const EDUCATION = [
  ...
  },
  {
    ...
    isDropout: true,
    dropoutMessage:
      'Completed 2 of 4 semesters, then I decided to drop out after the university had to close for 4 months due to ongoing protests to change the government.',
    institute: 'University of Constantine 2',
    projects: [
      'Developed an online ecommerce website using Wordpress and WooCommerce.',
      'Built my personal web app using the MEAN stack  (MongoDB, ExpressJs, Angular, Nodejs). ',
